...
function Action(options) {
    const criteriaBuilder = options.criteriaBuilder || new Action.CriteriaBuilder();
    ...
    const fn = function (context) {
        new ContextBuilder(criteriaBuilder).normalize(context);
...
InvalidCriteriaBuilderError.prototype = Object.create(Error.prototype);
function InvalidCriteriaBuilderError(obj) {
