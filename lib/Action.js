...
function Action(options) {
    ...
    function expose() {
        ...
        return (req, res) => {
            ...
            const context = new ContextBuilder(self.criteriaBuilder).buildHTTP(req, res);
    ...
    function io() {
        ...
        return (socket, data) => {
            const context = new ContextBuilder(self.criteriaBuilder).buildIO(socket, data);

            return self(context)
                .catch(handleError);

            function handleError(error) {
                return socket.emit('error', error); // Todo define a proper error handler for sockets
            }
        }
    }
}
